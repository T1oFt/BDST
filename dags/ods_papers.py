...
from services.ods.papers_etl import PapersExtractor, PapersTransformer, PapersLoader
...
with DAG(
    ...
    def load_fn(ti):
        ...
        ti.xcom_push('papers_etl_loaded_at', loaded_at.isoformat())
    ...
    trigger_dds = TriggerDagRunOperator(
        task_id='trigger_papers_dds',
        trigger_dag_id='papers_dds',
        conf={"loaded_at": "{{ ti.xcom_pull(task_ids='load_task', key='papers_etl_loaded_at') }}"},
    )
